...
ADMINISTRATIVE_TYPES = [
    ...
    (REGION, 'Region'),
    (CT_ABSTRACT, 'Kreis'),
    (CT_URBAN_MUNICIPALITY, 'Kreisfreie Stadt (Kreisebene)'),
    (CT_METROPOLITAN_AREA, 'Stadtkreis (Kreisebene)'),
    (CT_COUNTY, 'Kreis'),
    ...
    (MP_MARKET, 'Markt'),
    (MP_URBAN_MUNICIPALITY, 'Kreisfreie Stadt (Gemeindeebene)'),
    (MP_METROPOLITAN_AREA, 'Stadtkreis (Gemeindeebene)'),
    (MP_CITY, 'Stadt'),
